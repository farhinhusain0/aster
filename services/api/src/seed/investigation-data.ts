    ...
    return {
        ...
        "pdDetails": {
            ...
            "service": {
                ...
                "html_url": "https://worklifeteam.pagerduty.com/service-directory/PLGKKE5"
            },
            "assignments": [
                {
            ...
            "first_trigger_log_entry": {
                ...
                "html_url": "https://worklifeteam.pagerduty.com/incidents/Q2DBOAA5TSQGU6/log_entries/RP4AU2VACDJU6Y9KB44F4BIMCO",
                "created_at": "2025-12-21T10:58:10Z",
                "agent": {
                    "id": "PJR2RQJ",
                    ...
                    "html_url": "https://worklifeteam.pagerduty.com/services/PLGKKE5/integrations/PJR2RQJ"
                },
                "channel": {
                    "type": "api",
                    "service_key": "98e2c4f08c354408d045a093c0b383f1",
                    "description": "[FIRING:1] payment service transaction error Demo (Payment charge failed payment)",
                    "incident_key": "5eed518c62c55d3d5b4d79123e935c688fcb972a3ebdc76a43ae637a92c00152",
                    "details": {
                    ...
                    "cef_details": {
                        ...
                        "creation_time": null,
                        "dedup_key": "5eed518c62c55d3d5b4d79123e935c688fcb972a3ebdc76a43ae637a92c00152",
                        "description": "[FIRING:1] payment service transaction error Demo (Payment charge failed payment)",
                        "details": {
                            "firing": "\nValue: A=13.998833430547453\nLabels:\n - alertname = payment service transaction error\n - app_payment_failure = Payment charge failed\n - grafana_folder = Demo\n - job = payment\nAnnotations:\nSource: http://localhost/grafana/alerting/grafana/de8rnwee6fta8a/view?orgId=1\nSilence: http://localhost/grafana/alerting/silence/new?alertmanager=grafana&matcher=alertname%3Dpayment+service+transaction+error&matcher=app_payment_failure%3DPayment+charge+failed&matcher=grafana_folder%3DDemo&matcher=job%3Dpayment&orgId=1\n",
                            "num_firing": "1",
                        ...
                        "event_class": "default",
                        "message": "[FIRING:1] payment service transaction error Demo (Payment charge failed payment)",
                        "mutations": [],
                        "priority": null,
                    ...
                    "summary": "[FIRING:1] payment service transaction error Demo (Payment charge failed payment)",
                    "client_url": "http://localhost/grafana/",
                    "client": "Grafana"
                },
                "service": {
                ...
                "incident": {
                    ...
                    "summary": "[#1239] [FIRING:1] payment service transaction error Demo (Payment charge failed payment)",
            ...
            "escalation_policy": {
                ...
                "html_url": "https://worklifeteam.pagerduty.com/escalation_policies/POLQ8XD"
            },
            "teams": [],
            "impacted_services": [
                {
...
export const getGithubCheckData = () => {
    return {
        _id: new mongoose.Types.ObjectId("000000000000000000000001"),
        createdAt: new Date(),
        updatedAt: new Date(),
        "action": {
            "request": "PaymentService 500 error in charge.js processing logic, focusing on 'Payment charge failed' errors and transaction handling",
            "files": [
                {
                    "filename": "demo.ts",
        ...
        "result": {
            "summary": "A semantic search tool was used to look for code related to \"PaymentService 500 error in charge.js,\" focusing on errors like \"Payment charge failed\" and how transactions are handled. The tool found that when a payment fails—often due to issues with the Stripe payment system—the error is logged, tracked, and reported by the system. This matters because it shows that payment failures are being properly recorded, which is crucial for understanding and fixing the transaction errors users are experiencing.",
            "explanation": "This data is about how the PaymentService handles charging payments, especially when there are errors like \"Payment charge failed\" and 500 errors. The code shows that when a payment is processed, it tries to charge the card using an outside service (Stripe). If something goes wrong—like a problem with the Stripe API or the card—the system logs the error, records it for monitoring, and then returns a failure. This is important because it helps explain why users might see payment failures, and it shows that errors are being tracked and reported, which is key for investigating and fixing these issues."
        },
    }
}

export const getGrafanaCheckData = () => {
    return {
        _id: new mongoose.Types.ObjectId("000000000000000000000002"),
        createdAt: new Date(),
        updatedAt: new Date(),
        "action": {
            "request": "Show recent logs for payment service transaction errors, focusing on 'charge failed' events and any stack traces or error details.",
        ...
        "result": {
            "summary": "Grafana logs were checked to find out how many payment transactions failed in the last 24 hours, specifically looking for \"charge failed\" errors. The logs show 68 failed payments, but no extra details were given about why they failed. Knowing this helps figure out if customers are running into payment issues, which is important for fixing any problems with the payment system.",

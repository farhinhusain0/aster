...
class GithubRepositoryReader(BaseReader):
    ...
    def __init__(
        ...
        Args:
            ...
            - timeout (int or None): Timeout for the requests to the Github API. Default is 120.
            - retries (int): Number of retries for requests made to the Github API. Default is 5.
    ...
    async def get_tree_custom(
        ...
        Args:
            ...
            - `timeout (int or None)`: Timeout for the request in seconds. Default is 120.

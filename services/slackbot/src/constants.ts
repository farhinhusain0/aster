export function isEnterprise() {
  return !!process.env.ASTER_CLOUD_REGION;
}
...
Hi <@%s>! I'm Aster 🧙‍♂️, your AI assistant for all your production questions.
...
- \`/aster help\`: Shows this help message
- \`/aster new-chat\`: Resets the chat history
- \`/aster actions\`: Shows available, pre-defined actions
`;
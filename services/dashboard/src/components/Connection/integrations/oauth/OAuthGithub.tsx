  ...
  return (
    <ConnectionWrapper>
      <OrderedList style={{ marginTop: 0 }}>
        <li>
          Authorize Aster Github App through{" "}
          <a
        ...
        <li>
          Install Aster Github app on your desired organizations through{" "}
          <a
            href="https://github.com/apps/aster-app/installations/select_target"
            target="_blank"
          >
            this
          </a>{" "}

...
export const ModalOverlay = (props: AriaModalOverlayProps) => {
  return (
    <AriaModalOverlay
      ...
      className={(state) =>
        cx(
          "fixed inset-0 z-50 flex min-h-dvh w-full items-end justify-center overflow-y-auto bg-overlay/30 px-4 pt-4 pb-[clamp(16px,8vh,64px)] outline-hidden backdrop-blur-[2px] sm:items-center sm:justify-center sm:p-8",

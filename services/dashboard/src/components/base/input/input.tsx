...
export const InputBase = ({
  ...
  const hasTrailingIcon = tooltip || isInvalid || isPasswordType;
  ...
  return (
    ...
    >
      ...
      <AriaInput
        {...(inputProps as AriaInputProps)}
        type={isPasswordType && isVisible ? "text" : inputProps.type}
        ref={ref}
        placeholder={placeholder}
        className={cx(
          "m-0 w-full bg-transparent text-md text-primary ring-0 outline-hidden placeholder:text-placeholder autofill:rounded-lg autofill:bg-transparent autofill:text-primary autofill:shadow-none",
      ...
      {isPasswordType && (
        <AriaButton
          ...
          className={cx(
            "absolute cursor-pointer text-fg-quaternary transition duration-200 hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover focus:outline-none",
      ...
      {tooltip && !isInvalid && !isPasswordType && (

    ...
    >
      <div
        ...
        style={{
          ...
          /**
           * Hide the progress bar when the value is 0 to avoid layout thrashing.
           * This is a workaround to avoid the progress bar being visible when the value is 0.
           * We see a slight layout shift when the value is 0.
           */

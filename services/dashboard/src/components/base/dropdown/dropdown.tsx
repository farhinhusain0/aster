...
const DropdownItem = ({
  ...
  const textColor =
    variant === "danger" ? "text-error-primary" : "text-secondary";
  const textColorHover =
    variant === "danger" ? "text-error-primary_hover" : "text-secondary_hover";
        ...
        >
              ...
              className={cx(
                ...
                state.isDisabled
                  ...
                  : variant === "danger"
                    ? "text-error-primary"
                    : "text-secondary",
                state.isFocused && textColorHover,
              )}
            />
          )}
          ...
          <span
            className={cx(
              ...
              state.isDisabled ? "text-disabled" : textColor,
              state.isFocused && textColorHover,
            )}
          >
            {label ||
